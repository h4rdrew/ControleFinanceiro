    ...
    public partial class criacaoBancoDados : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Despesas_Categoria_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "Categoria",
                        principalColumn: "CategoriaId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "d0f71ca7-0ac2-43fc-a9f9-13bf0e3f7d28", "95111ed0-002d-4e10-a911-67c5ffce80a4", "Administrador do sistema", "Administrador", "ADMINISTRADOR" },
                    { "2728a1d2-33a6-4df0-a6b5-953b50c1f5f8", "9f14d1b8-e9f0-4072-952f-71f37326bbe0", "Usuário do sistema", "Usuario", "USUARIO" }
                });
